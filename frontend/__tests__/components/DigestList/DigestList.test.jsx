...
describe('DigestList', () => {
    ...
    it('should render error is flag is passed', () => {
        const component = shallow(<DigestList isError />);
        expect(component.equals(<h2>Error :(</h2>)).toBe(true);
    });

    it('should render loading spinner is flag is passed', () => {
    ...
    it('should render image selection request if it\'s not selected', () => {
        const component = shallow(<DigestList />);
        expect(component.equals(<h2>Please select image</h2>)).toBe(true);
    });

    it('should render empty repository message with path', () => {
        const props = {
            digest: {children: []},
            path: 'dalee/repo'
        };
    ...
    it('should render children as DigestItem', () => {
        const props = {
            digest: {
                children: [
